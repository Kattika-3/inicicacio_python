...
print(f"Això és un enter: {enter_1}, això és una float: {float_1}")

#Operadors aritmètics
operacio = enter_1-float_1 + 4
print(f"L'opercaió té com a resultat: {operacio} i es tipus{type(opercaio)}")

operacio_complexa = enter_1**5 + float_1/5 - 3*(enter_1 % 4)
print(operacio_complexa)

print(1%3,2%3,3%3,4%3,5%3,6%3)
